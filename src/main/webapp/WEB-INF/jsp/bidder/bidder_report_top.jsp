...
</div><div class="MenuMain"> <div class="MenuBtn"><a href="${bidder_home_url}/home" onMouseover="ddrivetip('Forward Market Price','', 'auto')";
onMouseout="hideddrivetip()">Forward Market</a></div>
    <div class="MenuBtnselected"><a href="${bidder_report_url}" onMouseover="ddrivetip('Won Bid','', 'auto')";
