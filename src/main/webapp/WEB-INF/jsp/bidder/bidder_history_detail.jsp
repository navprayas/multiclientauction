...
<div class="bidhistory" title="Bidding History">
	<table class="table table-bordered table-striped text-center">
		<tr>
			<td><form action="" method="post" name="form1" id="form3"
					style="margin: 0px;">
					<table class="table table-bordered table-striped text-center">

						<tr>
							<td colspan="2" align="left" valign="top" style="padding: 10px;"><table
									...
									<tr>
										<td><table width="100%" cellpadding="0" cellspacing="0">
												...
												<c:forEach var="biddingHistoryBean"
													items="${BiddingHistoryBean}">
													<tr>
														<td height="20" align="center" valign="middle"
															bgcolor="#EFEFF7" class="td">${biddingHistoryBean.bidDateAndTime}</td>
														<td align="center" valign="middle" bgcolor="#EFEFF7"
															class="td">${biddingHistoryBean.bidAmount}</td>
														<td align="center" valign="middle" bgcolor="#EFEFF7"
															class="td">${biddingHistoryBean.comment}</td>
														<td align="center" valign="middle" bgcolor="#EFEFF7"
															class="td">${biddingHistoryBean.bidType}</td>
													</tr>
												</c:forEach>
											</table></td>
									</tr>
									...
									<tr>
										<td><table width="100%" cellpadding="0" cellspacing="0"
												bordercolor="#ffffff" style="font: 11px calibri;">
												<tr>
