	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i>Bidder -
							Home</a></li>
								...
								<tr>
									...
									<td colspan="3"><input type="radio" name="radio"
										...
										href="${bidder_close_url}" class="subTitleLink">&nbsp;Closed
											Market</a></td>
									<td colspan="7"><strong>Total No. of Forward
											Markets in Active List: <c:out
							...
							<c:forEach items="${bidItemsList}" var="bidItem"
								...
								<tr class="table">
									...
									<td align="center" valign="middle" class="DetailBorRight">
										<div id="bidItemName${bidItem.bidItemId}"
											style="display: none">${bidItem.name}</div> <a href="#"
										class="LinkSelected"
	   ...
	   --></td>
									<td><a href="${bidItem.imageUrl}" target="_blank"> <img
											...
											onclick="window.open('${bidItem.imageUrl}', 'Large', 'width=500, height=350'); return false;"></td>
																							...
																							style="border-right: 1px solid #fff;"><table
																								...
																								<tr class="td">
																									<td height="25" colspan="2" align="center"
																										bgcolor="#EFEFE7" class="td">Are you
																										sure, you want to Remove the Auto Bid</td>
																								</tr>
																								<tr class="td">
