...
<form:form method="post" action="add.html" commandName="contact">
	...
	<table>
		<tr>
			<td><form:label path="bidItemId">
					<spring:message code="label.bidItemId" />
				</form:label></td>
			<td><form:input path="bidItemId" /></td>
		</tr>
		<tr>
			<td><form:label path="groupCode">
					<spring:message code="label.groupCode" />
				</form:label></td>
			<td><form:input path="groupCode" /></td>
		</tr>
		<tr>
			<td><form:label path="materialName">
					<spring:message code="label.materialName" />
				</form:label></td>
		...
		<tr>
			<td><form:label path="lastUpDateTime">
					<spring:message code="label.lastUpDateTime" />
				</form:label></td>
			<td><form:input path="lastUpDateTime" /></td>
		</tr>
		<tr>
			<td><form:label path="firstCreatedTime">
					<spring:message code="label.firstCreatedTime" />
				</form:label></td>
			<td><form:input path="firstCreatedTime" /></td>
		</tr>
		<tr>
			<td><form:label path="lengthRange">
					<spring:message code="label.lengthRange" />
				</form:label></td>
			<td><form:input path="lengthRange" /></td>
		</tr>
		<tr>
			<td><form:label path="actualLength">
					<spring:message code="label.actualLength" />
				</form:label></td>
			<td><form:input path="actualLength" /></td>
		</tr>
		<tr>
			<td><form:label path="document">
		...
		<tr>
			<td><form:label path="categoryId">
					<spring:message code="label.categoryId" />
				</form:label></td>
			<td><form:input path="categoryId" /></td>
		</tr>
		<tr>
			<td><form:label path="marketId">
					<spring:message code="label.marketId" />
				</form:label></td>
		...
		<tr>
			<td colspan="2"><input type="submit"
				value="<spring:message code="label.addBidItem"/>" /></td>
		</tr>
	</table>
</form:form>
<h3>BidItem</h3>
