...
<spring:url value="/superadmin/home" var="admin_home_url" />
<spring:url value="/superadmin/userauctionmap" var="user_auction_map_url" />
<spring:url value="/superadmin/registeradmin" var="userRegistration_url" />
<spring:url value="/superadmin/resetPasswordPage" var="passwordReset_url" />
